...
Let's load in an Excel file derived from a public dataset on water quality measurements. The dataset contains 500 samples with various measurements that are used to assess the quality of the water (pH, temperature, turbidity, oxygen and conductivity) <https://www.kaggle.com/datasets/shreyanshverma27/water-quality-testing>
